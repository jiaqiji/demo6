...
public:
  ...
  //##
  void set_function(CompFunction fun)
  {
    compFunction_ = fun;
  }
  CompFunction function() const{ return compFunction_;}

  void setTable(Table* pt)
  {
    table_ = pt;
  }
  Table* getTable()
...
private:
  CompOp        comp_ = NO_OP;
  CompFunction  compFunction_ = NO_FUC;
  FilterObj left_;
  FilterObj right_;
  Table*    table_;
};
